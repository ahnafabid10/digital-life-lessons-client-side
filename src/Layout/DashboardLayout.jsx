...
const DashboardLayout = () => {
  ...
  <div className="drawer-content">
    ...
    <nav className="navbar w-full bg-base-300">
      ...
      <div className="p-2 text-xl font-bold">Digital Life Lessons</div>
    </nav>
    {/* Page content here */}
    <Outlet></Outlet>
  </div>
    ...
    <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
      ...
      <ul className="menu w-full grow">
        ...
        <li>
            ...
            className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Add Lesson"
            >
        ...
        <li>
            <NavLink className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="My Lessons"
        ...
        <li>
            <NavLink className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="My Favourite"
             to='/dashboard/my-favourite'>
              <CiSaveDown2  className='text-black'/>
